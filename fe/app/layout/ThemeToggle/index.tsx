    ...
    <div>
      ...
      <label
        className={classNames(
          'flex items-center justify-center cursor-pointer w-8 h-8 rounded-full',
          { 'hover:bg-gray-800': isDark, 'hover:bg-gray-200': !isDark },
        )}
        htmlFor="light-switch"
      >
        <svg
          className={classNames('fill-current', {
            'hidden text-gray-400/80': isDark,
            'text-gray-500/80': !isDark,
          })}
          width={16}
          height={16}
          viewBox="0 0 16 16"
        ...
        <svg
          className={classNames('fill-current text-gray-500/80', {
            'hidden text-gray-500/80': !isDark,
            'block text-gray-400/80': isDark,
          })}
          width={16}
          height={16}
          viewBox="0 0 16 16"
